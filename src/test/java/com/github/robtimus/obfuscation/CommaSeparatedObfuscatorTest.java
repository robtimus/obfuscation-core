/*
 * CommaSeparatedObfuscatorTest.java
...
import static com.github.robtimus.obfuscation.PropertyObfuscator.commaSeparated;
...
public class CommaSeparatedObfuscatorTest {
    ...
    public void testObfuscateTextCharSequence() {
        ...
        String input = "xfoo=bar,hello=world,no-value,=no-keyy";
        String expected = "foo=***,hello=world,no-value,=no-key";
        ...
        input = "xfoo = bar , hello = world , no-value , = no-keyy";
        expected = "foo = ****, hello = world , no-value , = no-key";

        assertEquals(expected, obfuscator.obfuscateText(input + " , x = y", 1, input.length() - 1).toString());
        assertEquals("foo = **", obfuscator.obfuscateText(input, 1, 9).toString());
        assertEquals("foo", obfuscator.obfuscateText(input, 1, 4).toString());

        input = "xfoo = , hello = world , no-value , = no-keyy";
        expected = "foo = , hello = world , no-value , = no-key";
    ...
    public void testObfuscateTextReaderToAppendable() throws IOException {
        ...
        String input = "foo=bar,hello=world,no-value,=no-key";
        String expected = "foo=***,hello=world,no-value,=no-key";
        ...
        input = "foo = bar , hello = world , no-value , = no-key";
        expected = "foo = ****, hello = world , no-value , = no-key";
    ...
    Arguments[] testEquals() {
        ...
        return new Arguments[] {
                ...
                arguments(obfuscator, commaSeparated().build(), false),
    ...
    private Obfuscator createObfuscator() {
        return createObfuscator(commaSeparated());
    }
