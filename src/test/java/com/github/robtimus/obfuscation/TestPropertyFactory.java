...
public final class TestPropertyFactory implements PropertyObfuscatorFactory {
    ...
    public PropertyObfuscator createPropertyObfuscator(Builder builder) {
        return new TestObfuscator(builder);
    }

    public static final class TestObfuscator extends PropertyObfuscator {

        private TestObfuscator(Builder builder) {
            super(builder);
        }
